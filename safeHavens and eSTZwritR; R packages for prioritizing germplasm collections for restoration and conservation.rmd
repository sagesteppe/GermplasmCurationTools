...
All functions require species occurrence data, such as from GBIF, and readily available and easy to integrate into usage with `safeHavens` through the `rgbif` package, although taxa requiring enhanced cleaning may benefit from the use of gatoRs [@chamberlain2017rgbif; @patten2024gators]. 
